...
void ConversationManager::userMessChoise(User& user, Array<PrivateMessage>& arrPM, Array<CommonMessage>& arrCM)
{
    this->cleanConsole();
    ...
    if (sim == '1')  //написать сообщение в общий чат
    {
        ...
        CommonMessage* mes = new CommonMessage(mesNum, mes, name);
